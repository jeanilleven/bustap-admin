...
class _EmployeeListState extends State<EmployeeList> {
  ...
  Widget build(BuildContext context) {
    ...
    final employeeDisplay = employeeSnapshot
        .where((element) =>
            element.type == widget.employeeType && element.status == false)
        .toList();
                ...
                child: Padding(
                  ...
                  child: Row(
                      ...
                      children: [
                        Expanded(
                          child: Text(
                              employeeDisplay[index].hashCode.toString(),
                              style:
                        ...
                        Expanded(
                          flex: 2,
                          child: Text(
                              employeeDisplay[index].fname +
                                  ' ' +
                                  employeeDisplay[index].lname,
                              style: TextStyle(fontSize: 20)),
                        ),
                        Expanded(
                          flex: 2,
                          child: Text(employeeDisplay[index].email,
