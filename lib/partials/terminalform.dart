...
import '../partials/partials.dart';
  ...
  addTerminalForm(BuildContext context, String header, String opt, GlobalKey<FormState> _formKey, Terminal term) {
    return showDialog(
        context: context,
        builder: (context) {
          return Dialog(
                  ...
                  child: Padding(
                      ...
                      child: IntrinsicWidth(
                        ...
                        Container(
                          height: 75,
                          child: TextFormField(
                            controller: TextEditingController(text: term.stationnum),
                              ...
                              RaisedButton(
                               ...
                               onPressed: () {
                                    if(_formKey.currentState.validate()){
                                      submitTerminalForm(context, _formKey, term, opt);
                                    }
                                })
                            ],
                          ),
