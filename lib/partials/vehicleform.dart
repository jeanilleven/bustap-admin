...
import '../partials/partials.dart';
  ...
  addVehicleForm(
    BuildContext context, String header, String opt, GlobalKey<FormState> _formKey, Vehicle v) {
    return showDialog(
        context: context,
        builder: (context) {
          return Dialog(
                  ...
                  child: Padding(
                      ...
                      child: IntrinsicWidth(
                        ...
                        Container(
                          ...
                          child: TextFormField(
                            controller:
                                TextEditingController(text: v.platenum),
                            decoration: InputDecoration(
                              ...
                              RaisedButton(
                                ...
                                onPressed: () {
                                  if(_formKey.currentState.validate()){
                                    submitVehicleForm(context, _formKey, v, opt);
                                  }
                                }
                              )
                            ],
