...
class _TerminalListState extends State<TerminalList> {
  ...
  Widget build(BuildContext context) {
    ...
    final terminalDisplay =
        terminalSnapshot.where((element) => element.status == false).toList();
                ...
                child: Padding(
                    ...
                    child: Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            flex: 3,
                            child: Text(terminalDisplay[index].name,
                                style: TextStyle(fontSize: 20)),
                          ),
                          Expanded(
                            flex: 4,
                            child: Text(
                                terminalDisplay[index].street +
                                    ", " +
                                    terminalDisplay[index].city +
                                    ", " +
                                    terminalDisplay[index].province,
                          ...
                          Column(children: [
                            IconButton(
                              onPressed: () {
                                askConfirmation(context, terminalDisplay[index]);
                              },
                              tooltip: 'Delete',
